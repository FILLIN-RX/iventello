...
import { Save, Download, FileText, Satellite, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  async function handleExport() {
    ...
    try {
      const ws = XLSX.utils.json_to_sheet(exportRows.map((r) => ({
        'Date': `Jour ${r.day}`,
        'Réab. Access': r.reabonnementAccess,
        'Réab. Évasion': r.reabonnementEvasion,
        'Réab. Access+': r.reabonnementAccessPlus,
        'Réab. Tout Canal': r.reabonnementToutCanal,
        'Réab. Autres': r.reabonnementOthers,
        'Total Réabonnements': r.totalReabonnement,
        'Abonnement': r.abonnement,
        'Achat Décodeur': r.achatDecoder,
        'Install./Dépannage': r.installationDepannage,
      ...
      a.href = url
      a.download = `CanalPlus_${key}.xlsx`
      a.click()
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold">Module Canal+</h2>
        </div>
        <div className="flex items-center gap-2">
